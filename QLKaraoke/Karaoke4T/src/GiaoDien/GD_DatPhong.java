...
//		------------------------------------------
        ...
        testbutton.Buttontest btnChonPhongHat = new testbutton.Buttontest();
        ...
        btnChonPhongHat.setRippleColor(new Color(255, 255, 255));
        btnChonPhongHat.setShadowColor(new Color(0,0,0));
