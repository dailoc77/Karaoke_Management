...
public class GD_DatPhong extends JFrame implements ActionListener {
	...
	public GD_DatPhong() {
		...
		JLabel lbThongTinKH = new JLabel("");
		lbThongTinKH.setForeground(new Color(255, 255, 255));
		lbThongTinKH.setHorizontalAlignment(SwingConstants.CENTER);
		lbThongTinKH.setIcon(new ImageIcon(GD_Main_NV.class.getResource("/Imgs/370.png")));
		lbThongTinKH.setBounds(-95, -176, 1333, 957);
		contentPane.add(lbThongTinKH);
		
		JLabel lblNewLabel1 = new JLabel("");
		lblNewLabel1.setIcon(new ImageIcon(GD_DatPhong.class.getResource("/Imgs/370.png")));
		lblNewLabel1.setBounds(-40, -176, 1333, 957);
		contentPane.add(lblNewLabel1);
		
		JPanel TTKH_panel = new JPanel();
		TTKH_panel.setLayout(null);
		TTKH_panel.setBorder(null);
		TTKH_panel.setBackground(new Color(255, 255, 255));
		TTKH_panel.setBounds(0, 150, 294, 461);
		contentPane.add(TTKH_panel);
	}
