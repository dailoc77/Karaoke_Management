...
public class ThongKeHoaDon_DAO {
	...
	public ArrayList<Entity.ThongKeHoaDon> doctubang(){
		try {
			...
			while(rs.next()) {
				HoaDon maHD = new HoaDon(rs.getString(1),null,null,null,0,0,null,null);
				...
				HoaDon ngayLap = new HoaDon(null,null,null,rs.getDate(4),0,0,null,null);
				NhanVien tenNV = new NhanVien(null,rs.getString(5),null,null,null,null,null,null,null,null);
				HoaDon tongTien = new HoaDon(null,null,null,null,0,rs.getFloat(6),null,null);
